 ...
 */
 ...
 module.exports.GetStudents = function (req, res, next) {
     ...
     Student.find(
         ...
         // 2022.06.29 - 11:30:32 - dont show password or salt!
         '-password -salt',
         (err, students) => {
             if (err) {
                 return res.status(400).send({
 ...
 module.exports.UpdateStudent = function (req, res, next) {
     ...
     // 2022.06.29 - 11:30:32 - middleware doesnt work for updates, and can't use middlware for presave since server thinks we are creating duplicate student with same studentNumber
     let id = req.params.id;
 ...
 // 2022.06.29 - 11:30:32 - before deleting, removes reference from every course to this student
 // 2022.06.29 - 11:30:32 - Delete student
     ...
     Student.findById(studentId,
         (err, student) => {
             if (err) {
                 ...
                 // 2022.06.29 - 11:30:32 - find all courses this student is taking
                 student.courses.forEach(courseId => {
                     // 2022.06.29 - 11:30:32 - drop student from each of these courses
 ...
 // 2022.06.29 - 11:30:32 - don't need this...logout taken care of in ng app
